...
/* GET users listing. */
router.get('/',auth, users.getUser); //Here, users.getUser is a callback metod and we don't use () for callback functions if we don't pass any value in url i.e localhost:3000/users then NOT FOUND Error.

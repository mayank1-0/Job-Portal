...
/* APIs */
router.get('/api/v1/fetch/:openingid', publicURLController.publicURLgetOpeningProfile);
router.post('/applicant-registration', publicURLController.applicantRegistration);

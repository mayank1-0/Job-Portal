...
router.get('/api/v1/openings/:profileid', auth, openingsController.getOpeningProfile);
router.get('/api/v1/openingstimeline/:profileid', auth, openingsController.getOpeningProfileTimeline);

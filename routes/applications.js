...
router.get(
  "/applicants/profile/:profileid",
  authGurad,
  applicationController.applicantProfile
);

/* APIs */
router.get(
  "/api/v1/applicant/:applicationid",
  auth,
  applicationController.getApplicantProfile
);
router.get(
  "/api/v1/timeline/:applicationid",
  auth,
  applicationController.getTimeline
);
router.post(
  "/api/v1/add-timeline/:applicationid",
  auth,
  applicationController.addTimeline
);
router.put(
  "/api/v1/confirm-reject-candidate/:applicationid",
  auth,

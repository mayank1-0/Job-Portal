...
router.get("/", isLoggedIn, function (req, res, next) {
	...
	res.render("index", { title: "Login" }); //will search index file in views folder and there provides value "Express" for the key 'title'. Also, we can either use res.render() or res.send().
});
...
router.post("/send-password-reset-link", authentication.sendPasswordResetLink);
router.put("/reset-password/:email/:token", authentication.resetPassword);

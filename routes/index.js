...
/* GET home page. */
router.get('/', isLoggedIn, function(req, res, next) {  //get() method has 2 parameters. First argument is the path of the route. Second argument is a function which is invoked and itself takes three arguments

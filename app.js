...
// application's views to the path 'path.join(__dirname, 'views')' i.e /myapp3/views. Here _dirname is __dirname is the directory in which the currently executing script resides.
